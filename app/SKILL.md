---
name: talktobook
description: "TalkToBook: turn a YouTube URL or a transcript into a designed, attributed reading page, then Markdown and EPUB. Credits original speakers. CLI and Claude skill."
...
Make a book from a talk you own. A YouTube URL or a timestamped markdown
transcript becomes a designed reading page, then an attributed EPUB. Credit
original speakers. Claim no copyright over the source.
